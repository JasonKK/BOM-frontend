...
class StatisticRepository {
  ...
  Future<Statistic> getDailyTime() async {
    ...
    final http.Response response = await http
        .get(Uri.parse(urlApi + '/plan/total?date=${getToday()}&userId=1'));
  ...
  Future<Statistic> getWeekStar() async {
    ...
    final http.Response response = await http
        .get(Uri.parse(urlApi + '/plan/week/star?date=${getToday()}&userId=2'));
  ...
  Future<Statistic> getMonthstar() async {
    ...
    final http.Response response = await http.get(
        Uri.parse(urlApi + '/plan/month/star?date=${getToday()}&userId=2'));
...
/*한주의 시간 가져오는 코드 */
  Future<Statistic> getWeekTime() async {
    ...
    final http.Response response = await http.get(
        Uri.parse(urlApi + '/plan/week/average?date=${getToday()}&userId=2'));
...
/*한달의간시간 가져오는 코드 */
  Future<Todo> getMonthTime() async {
    ...
    final http.Response response = await http.get(
        Uri.parse(urlApi + '/plan/month/average?date=${getToday()}&userId=2'));
  ...
  Future<Statistic> getWeekTimeChart() async {
    ...
    final http.Response response = await http.get(
        Uri.parse(urlApi + '/plan/week/total?date=${getToday()}&userId=2'));
  ...
  Future<Statistic> getMonthTimChart() async {
    ...
    final http.Response response = await http.get(
        Uri.parse(urlApi + '/plan/month/total?date=${getToday()}&userId=2'));
